...
![Size](https://img.shields.io/badge/download-~390_KB_gzipped-1a1d24)
...
partly the reason the whole thing is ~390 KB over the wire and loads in seconds.
...
Moon's 1.54° axial tilt caps the real sun near 18° at 72° north, and lets it set
...
src/
  main.js           bootstrap, loading, menus, frame loop        793
  core/
    ...
    save.js         localStorage                                  23
  world/
    terrain.js      bake, clipmap, excavation, trails, sun mask 1232
    props.js        boulders, the sled, VANTAGE-3, relays        587
    sky.js          stars, Milky Way, sun, Earth, IBL            358
    dust.js         ballistic regolith                           211
    textures.js     procedural Earth and lunar albedo            130
  game/
    rover.js        the machine and its physics                  916
    gameplay.js     radar, drill, power, missions                646
    lore.js         codex, samples, mission definitions          208
    content.js      landmarks, world content, mission gates       20
    camera.js       chase / orbit / mast / photo                 179
  ui/
    hud.js          instruments, minimap, codex                  526
